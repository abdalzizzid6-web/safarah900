                      ...
                      <AnimatePresence>
                        {showSettings && (
                          <motion.div 
                            ...
                            className="absolute bottom-full right-0 mb-4 w-72 bg-neutral-900/95 backdrop-blur-3xl rounded-2xl p-4 border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.85)] z-40"
                          >
                             {/* MAIN AUDIO SETTINGS MENU */}
                             {activeMenu === 'main' && (
                               <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-1 text-right">
                                  ...
                                  {isM3U8 && (
                                    <>
                                      <button 
                                        ...
                                        className="flex items-center justify-between w-full p-2.5 hover:bg-white/5 rounded-xl transition-all cursor-pointer"
                                      >
                               ...
                               <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3 text-right">
                                  ...
                                  <div className="flex items-center justify-center gap-2 py-1 bg-black/40 rounded-xl">
                                    <button
                                      ...
                                      className="p-2 hover:text-amber-500 text-white/70"
                                      title="تصغير"
                                    >
                                      <ZoomOut size={16} />
                                    </button>
                                  ...
                                  <div className="grid grid-cols-2 gap-2">
                                    <button
                                      ...
                                      className={`py-2 px-3 rounded-xl border text-[10px] font-black text-center ${
                             ...
                             {activeMenu === 'aspect' && (
                               <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-3">
                                  <button 
                                    onClick={() => setActiveMenu('main')}
                                    className="flex items-center gap-2 text-[10px] font-black uppercase text-gray-400 hover:text-white w-full pb-2 border-b border-white/5"
                                  >
